...
{/* // NOVO — dodaj Redis Health link ispred Clear all overrides dugmeta: */}
<a
  href="/api/admin/redis-monitor"
  target="_blank"
  rel="noopener noreferrer"
  className="flex items-center gap-2 px-3 py-2 md:px-4 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 rounded-lg border border-emerald-500/30 transition-colors"
  title="Redis memorija i status ključeva"
>
  <Activity className="w-4 h-4" />
  <span className="hidden sm:inline">Redis Health</span>
</a>
